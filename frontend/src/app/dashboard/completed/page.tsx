  ...
  useEffect(() => {
    ...
    const fetchTasks = async () => {
      try {
        ...
        console.error(err);
        setError('An error occurred while fetching completed tasks');
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-black p-4">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-400">Loading completed tasks...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-400">View your completed tasks</p>
      </div>
