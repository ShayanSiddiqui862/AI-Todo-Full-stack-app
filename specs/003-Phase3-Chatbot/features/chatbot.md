...
**Created**: 2026-02-07
**Status**: Draft
**Input**: AI-powered chatbot that allows authenticated users to manage their Todo list via natural language using OpenAI ChatKit UI, Agents SDK, and MCP tools
